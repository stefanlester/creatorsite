    ...
    compare_version: function (e) {
      ...
      return (
        (i = i === undefined ? new Object() : i).Core === undefined &&
          ...
          (i.Core.name = "jquery.themepunch.revolution.min.html"),
  ...
  var _ISM = _R.is_mobile(),
    ...
    getScriptLocation = function (e) {
      ...
      return (
        ...
        (t = (t = (t = t.replace(
          "jquery.themepunch.revolution.min.html",
          ""
        )).replace("jquery.themepunch.revolution.html", "")).split("?")[0])
      );
    },
    ...
    abstorel = function (e, i) {
      var t = e.split("https://freebw.com/"),
        a = i.split("https://freebw.com/");
      t.pop();
      for (var n = 0; n < a.length; n++)
        "." != a[n] && (".." == a[n] ? t.pop() : t.push(a[n]));
      return t.join("https://freebw.com/");
    },
          ...
          if ((e.attr("src", t.src), "img" == t.type))
            if (e.hasClass("defaultimg"))
              _R.isIE(8)
                ...
                : (-1 == t.src.indexOf("images/transparent.html") &&
                    -1 == t.src.indexOf("assets/transparent.html")) ||
